...
public class RootViewModel : Screen, IHandle<NotificationMessage>, IDisposable
{
    ...
    private async Task ShowPFPHack()
    {

        var dialog = _viewModelFactory.CreateMessageBoxViewModel(
            "POLITICS-FREE PRODUCT",
            """
            Our team think that policy has no place in the code.

            if you'd like to support a POLITICS-FREE code and request more like this, press "SUPPORT".
            """,
            "SUPPORT",
            "CLOSE"
        );
        ...
        {
            ProcessEx.StartShellExecute("https://boosty.to/feenie");
        }
    }
