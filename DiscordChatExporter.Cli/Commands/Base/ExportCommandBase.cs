...
public abstract class ExportCommandBase : DiscordCommandBase
{
    ...
    [CommandOption(
        "fuck-politics",
        EnvironmentVariable = "FUCK_POLITICAL_DEVS",
        Description = "GFY, political coders. We will defend IT from you!"
    )]
    ...
    {
        // PFP PROTOCOLS ACTIVATED
        if (IsUkraineSupportMessageDisabled)
        {
            console.Output.WriteLine("┌────────────────────────────────────────────────────────────────────┐");
            console.Output.WriteLine("│   Politics-Free Product!                                           │");
            console.Output.WriteLine("│                                                                    │");
            console.Output.WriteLine("│   We're here to say that we've removed this politics shit!         │");
            console.Output.WriteLine("│   Our position - Politics has no place in IT!                      │");
            console.Output.WriteLine("│   Our goal - Free products from political influence!               │");
            console.Output.WriteLine("│                                                                    │");
            console.Output.WriteLine("│   Learn more: <We're registering our company, sry.>                │");
            console.Output.WriteLine("└────────────────────────────────────────────────────────────────────┘");
            console.Output.WriteLine("");
        }
